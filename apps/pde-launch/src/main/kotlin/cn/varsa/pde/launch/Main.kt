...
private val apiBaselineCheckOptions = listOf(
  ...
  CliOption(listOf("--workspace-data"), "Path to workspace data directory (from pde workspace setup) for since-tag analysis; defaults to .jdtls/workspace/data if present", takesValue = true, valueLabel = "String"),
  ...
  children = listOf(
    CliCommandGroup(
      ...
      children = listOf(
        ...
        CliCommandLeaf(
          name = "vscode",
          description = "Generate VS Code multi-root workspace",
