...
```text
Usage: pde add-test-helper [-hV] [<args>...]
...
```text
Usage: pde ide-init idea [-hV] [<args>...]
...
```text
Usage: pde ide-init jdtls [-hV] [<args>...]
