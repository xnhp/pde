...
- Merge branch 'feat/remove-dry-run-behaviour' into knime (b871d45)
...
- Merge branch 'vscode-launch-debug' into knime (452396f)
- compat with current IJ version (a7900e9)
- no recover workspace (0a1b233)
- Merge branch 'feat/pde-help-tree' into integration/pde-todos (5606b56)
- Merge branch 'feat/dot-target-layout' into integration/pde-todos (76f9f1b)
- Merge branch 'feat/api-baseline-rework' into integration/pde-todos (612ccab)
- Merge branch 'feat/jdt-workspace-rename' into integration/pde-todos (2541f06)
- Merge branch 'chore/remove-add-test-helper' into integration/pde-todos (c308c9a)
- Rename pde workspace/jdt-build commands to jdt-workspace group (f500511)
- test improvements (e1df93d)
- Merge branch 'cli-integration' into knime (6a93b26)
- Merge branch 'fix/api-analyze-singleton-scope-collision' (30b3aec)
- Merge branch 'fix/api-analyze-fragment-host-closure' (12408dd)
