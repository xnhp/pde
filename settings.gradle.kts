...
include(":pde-coverage")
include(":pde-testflow")
include(":pde-cli-support")
...
project(":pde-coverage").projectDir = file("core/pde-coverage")
project(":pde-testflow").projectDir = file("core/pde-testflow")
project(":pde-cli-support").projectDir = file("core/pde-cli-support")
