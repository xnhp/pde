...
private val testPositionals = listOf(
  CliPositionalArg(0, "configPos", "YAML launch configuration (positional)", "0..1"),
  CliPositionalArg(1, "testPos", "Test name (optional, ignored with --all)", "0..1")
)
...
private val testOptions = listOf(
  ...
  CliOption(listOf("--all"), "Run all tests defined in the config in sequence (ignores test name)"),
  ...
  CliOption(listOf("--include"), "Regex filter to include tests", takesValue = true, valueLabel = "String", arity = "1"),
